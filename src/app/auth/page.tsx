        ...
        >
          ...
          <div className="glass rounded-2xl p-6 gradient-line">
            ...
            <div className="flex gap-2">
              <button className="flex-1 py-2.5 px-3 rounded-lg flex items-center justify-center gap-2 cursor-pointer transition-all duration-300" style={{ background: COLORS.primary }}>
                ...
                <span className="text-xs text-white" style={{ fontFamily: 'var(--font-jakarta)' }}>Google</span>
              </button>
              <button className="flex-1 py-2.5 px-3 rounded-lg flex items-center justify-center gap-2 cursor-pointer transition-all duration-300" style={{ background: 'transparent', border: `1px solid ${COLORS.primary}`, color: COLORS.primary }}>
                ...
                <span className="text-xs" style={{ fontFamily: 'var(--font-jakarta)', color: COLORS.primary }}>GitHub</span>
              </button>
            </div>
          </div>
